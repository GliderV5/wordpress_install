...
while 1==1:
	...
	if choix == str(1):
		...
		os.system("cd /var/www/html/ && sudo rm * && sudo wget https://wordpress.org/latest.zip -O /var/www/html/wordpress.zip // to download wordpress && sudo unzip wordpress.zip && sudo chmod 755 wordpress -R && sudo chown www-data wordpress -R")
		print()
		print()
		print()
		print("install is down !")
		print()
		print()
		print()
		sys.exit()
